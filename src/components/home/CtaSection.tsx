    ...
    <section className={`py-16 px-6 md:px-12 ${isRtl ? 'text-right' : 'text-left'}`}>
      <div className="max-w-5xl mx-auto">
        <div className="glass-card relative overflow-hidden rounded-3xl">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-solidy-blue/10 to-solidy-mint/10 dark:from-solidy-blue/5 dark:to-solidy-mint/5"></div>
          <div className="absolute -top-24 -right-24 w-64 h-64 bg-solidy-blue/20 dark:bg-solidy-blue/10 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-solidy-mint/20 dark:bg-solidy-mint/10 rounded-full blur-3xl"></div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10 p-10 md:p-16">
            <div className="flex-1">
              ...
              <Button size="lg" className="rounded-full bg-gradient-to-r from-solidy-blue to-solidy-mint hover:opacity-90 transition-opacity group">
